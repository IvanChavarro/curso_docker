package org.udemy.springcloud.msvc.auth;
...
public class SecurityConfig {
	...
	// filtro para el manejo de errores
	@Bean
	@Order(1)
	...
	// Da autorización a los endpoints
	@Bean
	@Order(2)
...
//		UserDetails userDetails = User.withDefaultPasswordEncoder().username("admin").password("12345").roles("USER")
//				.build();
//
//		return new InMemoryUserDetailsManager(userDetails);
//	}

	// se inyecta el AuthenticationManagerBuilder y configuramos el
	// userDetailsService para el login
	@Autowired
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(userDetailsService).passwordEncoder(passwordEncoder());
	}

	// registro de aplicaciones frontend (Postman, angular, react, etc...)
	@Bean
	...
	// crea la llave para la firma del token
	@Bean

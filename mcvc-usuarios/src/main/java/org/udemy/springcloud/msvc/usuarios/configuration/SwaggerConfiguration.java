package org.udemy.springcloud.msvc.usuarios.configuration;
...
public class SwaggerConfiguration {
	...
	public OpenAPI springShopOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("API DE UDEMY PARA DOCKER: USUARIOS").description("Microservicio de usuarios").version("v0.0.1")
